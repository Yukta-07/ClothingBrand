...
import PrductReviewCard from './PrductReviewCard'
...
<section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10'>
     ...
     <div className="flex flex-col items-center">
        ...
        <img
          ...
          {product.images.map((image) => <div className='aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[6rem]'>
            <img
              alt={image.alt}
              src={image.src}
             className='h-full w-full object-cover object-center '
   ...
   {/* Product info */}
   <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-8">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
           ...
           <div className='flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6'>
            ...
            <p className='opacity-50 line-through'>{product.mrp}</p>
           ...
           <div>
            ...
            <p className='ml-3 text-sm font-medium text-indigo-50'>3870 Reviews</p>
            </div>
...
<section>
  <h1 className='font-semibold pb-4 text-lg'>Recent Reviews and Ratings</h1>
  <div className='p-5 border'>
    <Grid2 container spacing={7}
    >
<Grid2 item xs={7}>
  <div className='space-y-5'>
{[1,1,1].map((item) => <PrductReviewCard/>)}
  </div>
</Grid2>
<Grid2 item xs={5}>
<h1 className='text-xl font-semibold pb-1'>Customer Ratings</h1>
<div className='flex items-center space-x-3'>
...
<p>Excellent</p>
    ...
    <LinearProgress
          sx={{
            borderRadius: 4,
            height: 7,
            width: '100%',  // Ensure the width is 100% to occupy available space
          }}
          variant="determinate"
...
<section className='pt-10'>
  <h1 className='py-5 font-bold text-lg'>You might also like</h1>
  <div className='flex flex-wrap space-y-5'>
{products.map((item) => <HomeCards product={item}/>)}
